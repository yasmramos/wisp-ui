...
export const Alert: React.FC<AlertProps> = ({
  ...
  return (
    <div className={`${baseStyles} ${variants[variant]} ${className}`} role="alert">
      <div className={variants[variant].split(' ')[3]}>{icons[variant]}</div>
      ...
      {closable && (
        <button
          onClick={handleClose}
          className="ml-auto -mr-2 p-1 rounded-full hover:bg-black/10 dark:hover:bg-white/10 transition-colors"
